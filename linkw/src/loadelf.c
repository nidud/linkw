...
/***********************************/
{
	...
	hdr->ph64->p_vaddr = sizeof(Elf64_Ehdr) + FmtData.base.x86;
		hdr->ph64->p_paddr = 0;
	...
	hdr->ph32->p_vaddr = sizeof(Elf32_Ehdr) + FmtData.base.x86;
		hdr->ph32->p_paddr = 0;
...
/**************************************************************************/
{
    ...
    sh->sh_addr = ph->p_vaddr = group->linear + FmtData.base.x86;
    ph->p_type = PT_LOAD;
