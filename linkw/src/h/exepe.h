...
typedef unsigned_32	pe_va;
 ...
 typedef unsigned long long  pe_va64;
#else
 typedef unsigned __int64    pe_va64;
#endif
...
typedef struct {
    ...
    unsigned_16		flags;
    /* optional header */
    unsigned_16		magic;		/* 0x10b=32-bit */
...
typedef struct {
    ...
    unsigned_16		flags;
    /* optional header */
    unsigned_16		magic;		/* 0x20b=64-bit */
    unsigned_8		lnk_major;
    unsigned_8		lnk_minor;
    unsigned_32		code_size;
    unsigned_32		init_data_size;
    ...
    unsigned_16		subsystem;
    unsigned_16		dll_flags;
    pe_va64		stack_reserve_size;
    pe_va64		stack_commit_size;
    pe_va64		heap_reserve_size;
...
enum {
    ...
    PE_FLG_LARGEADDRESSAWARE= 0x0020,	    /* jwlink */
